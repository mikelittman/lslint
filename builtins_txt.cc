...
"float llAcos( float Value )",
"void llAddToLandBanList( key ID, float Hours )",
"void llAddToLandPassList( key ID, float Hours )",
...
"integer llCeil( float Value )",
"string llChar( integer value )",
"void llClearCameraParams(  )",
"void llClearExperience( key AgentID, key ExperienceID )",
"void llClearExperiencePermissions( key AgentID )",
"integer llClearLinkMedia( integer Link, integer Face )",
"integer llClearPrimMedia( integer Face )",
"void llCloseRemoteDataChannel( key ChannelID )",
...
"key llFindNotecardTextCount( string NotecardName, string Pattern, list Options )",
...
"list llGetAttachedListFiltered( key AgentID, list Options )",
...
"float llGetEnergy(  )",
"string llGetEnv( string DataRequest )",
"list llGetEnvironment( vector Position, list EnvParams )",
"list llGetExperienceDetails( key ExperienceID )",
"string llGetExperienceErrorMessage( integer Error )",
"list llGetExperienceList( key AgentID )",
"vector llGetForce(  )",
...
"string llGetInventoryAcquireTime( string InventoryItem )",
...
"integer llGetInventoryPermMask( string InventoryItem, integer BitMask )",
"integer llGetInventoryType( string InventoryItem )",
"key llGetKey(  )",
"key llGetLandOwnerAt( vector Position )",
...
"integer llGetLinkNumberOfSides( integer LinkNumber )",
"list llGetLinkPrimitiveParams( integer LinkNumber, list Parameters )",
"integer llGetLinkSitFlags( integer LinkNumber )",
"integer llGetListEntryType( list ListVariable, integer Index )",
"integer llGetListLength( list ListVariable )",
...
"vector llGetOmega(  )",
"key llGetOwner(  )",
"key llGetOwnerKey( key ObjectID )",
"list llGetParcelDetails( vector Position, list ParcelDetails )",
"integer llGetParcelFlags( vector Position )",
"integer llGetParcelMaxPrims( vector Position, integer SimWide )",
"string llGetParcelMusicURL(  )",
"integer llGetParcelPrimCount( vector Position, integer Category, integer SimWide )",
"list llGetParcelPrimOwners( vector Position )",
"integer llGetPermissions(  )",
"key llGetPermissionsKey(  )",
"list llGetPhysicsMaterial(  )",
"vector llGetPos(  )",
"list llGetPrimMediaParams( integer Face, list Parameters )",
...
"integer llGetScriptState( string ScriptName )",
...
"vector llGetVel(  )",
"list llGetVisualParams( key ID, list Parameters )",
"float llGetWallclock(  )",
"integer llGiveAgentInventory( key AgentID, string FolderName, list InventoryItems, list Options )",
"void llGiveInventory( key TargetID, string InventoryItem )",
"void llGiveInventoryList( key TargetID, string FolderName, list InventoryItems )",
"integer llGiveMoney( key AvatarID, integer Amount )",
"void llGodLikeRezObject( key InventoryItemID, vector Position )",
"float llGround( vector Offset )",
"vector llGroundContour( vector Offset )",
"vector llGroundNormal( vector Offset )",
"void llGroundRepel( float Height, integer Water, float Tau )",
"vector llGroundSlope( vector Offset )",
"string llHMAC( string Key, string Message, string Algorithm )",
"key llHTTPRequest( string URL, list Parameters, string Body )",
"void llHTTPResponse( key HTTPRequestID, integer Status, string Body )",
"integer llHash( string value )",
"string llInsertString( string TargetVariable, integer Position, string SourceVariable )",
"void llInstantMessage( key AvatarID, string Text )",
...
"void llLinkSetSoundQueueing( integer LinkNumber, integer QueueEnable )",
...
"integer llLinksetDataCountFound( string search )",
...
"float llList2Float( list ListVariable, integer Index )",
"integer llList2Integer( list ListVariable, integer Index )",
...
"list llList2ListStrided( list ListVariable, integer Start, integer End, integer Stride )",
"rotation llList2Rot( list ListVariable, integer Index )",
"string llList2String( list ListVariable, integer Index )",
"vector llList2Vector( list ListVariable, integer Index )",
...
"float llListStatistics( integer Operation, list ListVariable )",
...
"void llMakeSmoke( integer Particles, float Scale, float Velocity, float Lifetime, float Arc, string Texture, vector Offset )",
...
"void llModifyLand( integer Action, integer Area )",
...
"void llReleaseCamera( key AvatarID )",
"void llReleaseControls(  )",
"void llReleaseURL( string URL )",
"void llRemoteDataReply( key ChannelID, key MessageID, string sData, integer iData )",
"void llRemoteDataSetRegion(  )",
"void llRemoteLoadScript( key Target, string ScriptName, integer Unknown1, integer Unknown2 )",
"void llRemoteLoadScriptPin( key ObjectID, string ScriptName, integer PIN, integer Running, integer StartParameter )",
"void llRemoveFromLandBanList( key AvatarID )",
...
"string llReplaceSubString( string InitialString, string SubString, string NewSubString, integer Count )",
"key llRequestAgentData( key AvatarID, integer Data )",
"key llRequestDisplayName( key AvatarID )",
"void llRequestExperiencePermissions( key AgentID, string unused )",
...
"key llRezObjectWithParams( string InventoryItem, list Parms )",
"float llRot2Angle( rotation Rotation )",
"vector llRot2Axis( rotation Rotation )",
"vector llRot2Euler( rotation Rotation )",
"vector llRot2Fwd( rotation Rotation )",
...
"integer llScaleByFactor( float ScalingFactor )",
"void llScaleTexture( float Horizontal, float Vertical, integer Face )",
"integer llScriptDanger( vector Position )",
"void llScriptProfiler( integer State )",
"key llSendRemoteData( key ChannelID, string Destination, integer Value, string Text )",
...
"integer llSetExperienceKey( key ExperienceID )",
...
"void llSetInventoryPermMask( string InventoryItem, integer PermissionFlag, integer PermissionMask )",
"void llSetKeyframedMotion( list Keyframes, list Options )",
"void llSetLinkAlpha( integer LinkNumber, float Opacity, integer Face )",
...
"integer llSetLinkMedia( integer Link, integer Face, list Parameters )",
"void llSetLinkPrimitiveParams( integer LinkNumber, list Parameters )",
"void llSetLinkPrimitiveParamsFast( integer LinkNumber, list Parameters )",
"void llSetLinkRenderMaterial( integer LinkNumber, string RenderMaterial, integer Face )",
"void llSetLinkSitFlags( integer LinkNumber, integer Flags )",
"void llSetLinkTexture( integer LinkNumber, string Texture, integer Face )",
"void llSetLinkTextureAnim( integer LinkNumber, integer Mode, integer Face, integer SizeX, integer SizeY, float Start, float Length, float Rate )",
"void llSetLocalRot( rotation Rotation )",
...
"void llSetPayPrice( integer Price, list QuickButtons )",
...
"void llSetScriptState( string ScriptName, integer Running )",
"void llSetSitText( string Text )",
"void llSetSoundQueueing( integer QueueEnable )",
...
"void llSitTarget( vector Offset, rotation Rotation )",
"void llSleep( float Time )",
...
"void llStartObjectAnimation( string Animation )",
"void llStopAnimation( string Animation )",
"void llStopHover(  )",
"void llStopLookAt(  )",
...
"void llTakeCamera( key AvatarID )",
...
"void llTargetRemove( integer Target )",
...
"void llTeleportAgentGlobalCoords( key AvatarID, vector GlobalPosition, vector RegionPosition, vector LookAtPoint )",
"void llTeleportAgentHome( key AvatarID )",
"void llTextBox( key AvatarID, string Text, integer Channel )",
"string llToLower( string Text )",
"string llToUpper( string Text )",
...
"integer llVerifyRSA( string PublicKey, string Message, string Signature, string Algorithm )",
"void llVolumeDetect( integer DetectEnabled )",
"void llWanderWithin( vector Origin, vector Area, list Options )",
...
"const integer CHARACTER_CMD_JUMP = 0x01",
"const integer CHARACTER_CMD_SMOOTH_STOP = 2",
"const integer CHARACTER_CMD_STOP = 0x00",
...
"const integer DEREZ_TO_INVENTORY = 2",
...
"const integer ESTATE_ACCESS_ALLOWED_AGENT_ADD = 4",
"const integer ESTATE_ACCESS_ALLOWED_AGENT_REMOVE = 8",
"const integer ESTATE_ACCESS_ALLOWED_GROUP_ADD = 16",
"const integer ESTATE_ACCESS_ALLOWED_GROUP_REMOVE = 32",
"const integer ESTATE_ACCESS_BANNED_AGENT_ADD = 64",
"const integer ESTATE_ACCESS_BANNED_AGENT_REMOVE = 128",
...
"const integer GAME_CONTROL_BUTTON_A = 0x1",
"const integer GAME_CONTROL_BUTTON_B = 0x2",
"const integer GAME_CONTROL_BUTTON_BACK = 0x10",
"const integer GAME_CONTROL_BUTTON_DPAD_DOWN = 0x1000",
"const integer GAME_CONTROL_BUTTON_DPAD_LEFT = 0x2000",
"const integer GAME_CONTROL_BUTTON_DPAD_RIGHT = 0x4000",
"const integer GAME_CONTROL_BUTTON_DPAD_UP = 0x800",
"const integer GAME_CONTROL_BUTTON_GUIDE = 0x20",
"const integer GAME_CONTROL_BUTTON_LEFTSHOULDER = 0x200",
"const integer GAME_CONTROL_BUTTON_LEFTSTICK = 0x80",
"const integer GAME_CONTROL_BUTTON_MISC1 = 0x8000",
"const integer GAME_CONTROL_BUTTON_PADDLE1 = 0x10000",
"const integer GAME_CONTROL_BUTTON_PADDLE2 = 0x20000",
"const integer GAME_CONTROL_BUTTON_PADDLE3 = 0x40000",
"const integer GAME_CONTROL_BUTTON_PADDLE4 = 0x80000",
"const integer GAME_CONTROL_BUTTON_RIGHTSHOULDER = 0x400",
"const integer GAME_CONTROL_BUTTON_RIGHTSTICK = 0x100",
"const integer GAME_CONTROL_BUTTON_START = 0x40",
"const integer GAME_CONTROL_BUTTON_TOUCHPAD = 0x100000",
"const integer GAME_CONTROL_BUTTON_X = 0x4",
"const integer GAME_CONTROL_BUTTON_Y = 0x8",
"const integer GCNP_GET_WALKABILITY = 2",
...
"const float LEGACY_MASS_FACTOR = 0.01",
...
"const integer OBJECT_PERMS = 53",
"const integer OBJECT_PERMS_COMBINED = 54",
...
"const integer OBJECT_RETURN_PARCEL = 1",
"const integer OBJECT_RETURN_PARCEL_OWNER = 2",
"const integer OBJECT_RETURN_REGION = 4",
...
"const integer OVERRIDE_GLTF_BASE_ALPHA = 2",
"const integer OVERRIDE_GLTF_BASE_ALPHA_MASK = 4",
"const integer OVERRIDE_GLTF_BASE_ALPHA_MODE = 3",
"const integer OVERRIDE_GLTF_BASE_COLOR_FACTOR = 1",
"const integer OVERRIDE_GLTF_BASE_DOUBLE_SIDED = 5",
"const integer OVERRIDE_GLTF_EMISSIVE_FACTOR = 8",
"const integer OVERRIDE_GLTF_METALLIC_FACTOR = 6",
"const integer OVERRIDE_GLTF_ROUGHNESS_FACTOR = 7",
...
"const integer PARCEL_FLAG_LINDEN_HOMES = 0x800000",
...
"const integer PERMISSION_RETURN_OBJECTS = 65536",
...
"const integer PRIM_COLLISION_SOUND = 53",
...
"const integer PRIM_MEDIA_PERM_ANYONE = 4",
"const integer PRIM_MEDIA_PERM_GROUP = 2",
"const integer PRIM_MEDIA_PERM_NONE = 0",
"const integer PRIM_MEDIA_PERM_OWNER = 1",
...
"const integer PSYS_SRC_OBJ_REL_MASK = 0x1",
...
"const integer PU_EVADE_HIDDEN = 0x07",
"const integer PU_EVADE_SPOTTED = 0x08",
"const integer PU_FAILURE_DYNAMIC_PATHFINDING_DISABLED = 10",
"const integer PU_FAILURE_INVALID_GOAL = 0x03",
"const integer PU_FAILURE_INVALID_START = 0x02",
"const integer PU_FAILURE_NO_NAVMESH = 0x09",
"const integer PU_FAILURE_NO_VALID_DESTINATION = 0x06",
"const integer PU_FAILURE_OTHER = 1000000",
"const integer PU_FAILURE_PARCEL_UNREACHABLE = 11",
"const integer PU_FAILURE_TARGET_GONE = 0x05",
"const integer PU_FAILURE_UNREACHABLE = 0x04",
"const integer PU_GOAL_REACHED = 0x01",
"const integer PU_SLOWDOWN_DISTANCE_REACHED = 0x00",
...
"const integer REGION_FLAG_BLOCK_FLYOVER = 0x8000000",
...
"const integer REZ_FLAG_BLOCK_GRAB_OBJECT = 0x0080",
"const integer REZ_FLAG_DIE_ON_COLLIDE = 0x0008",
"const integer REZ_FLAG_DIE_ON_NOENTRY = 0x0010",
"const integer REZ_FLAG_NO_COLLIDE_FAMILY = 0x0040",
"const integer REZ_FLAG_NO_COLLIDE_OWNER = 0x0020",
"const integer REZ_FLAG_PHANTOM = 0x0004",
"const integer REZ_FLAG_PHYSICAL = 0x0002",
"const integer REZ_FLAG_TEMP = 0x0001",
...
"const integer SIT_FLAG_ALLOW_UNSIT = 0x0002",
"const integer SIT_FLAG_NO_COLLIDE = 0x0010",
"const integer SIT_FLAG_NO_DAMAGE = 0x0020",
"const integer SIT_FLAG_SCRIPTED_ONLY = 0x0004",
"const integer SIT_FLAG_SIT_TARGET = 0x0001",
...
"const integer TARGETED_EMAIL_OBJECT_OWNER = 0x02",
"const integer TARGETED_EMAIL_ROOT_CREATOR = 0x01",
"const integer TERRAIN_DETAIL_1 = 0",
"const integer TERRAIN_DETAIL_2 = 1",
"const integer TERRAIN_DETAIL_3 = 2",
"const integer TERRAIN_DETAIL_4 = 3",
"const integer TERRAIN_HEIGHT_RANGE_NE = 7",
"const integer TERRAIN_HEIGHT_RANGE_NW = 6",
"const integer TERRAIN_HEIGHT_RANGE_SE = 5",
"const integer TERRAIN_HEIGHT_RANGE_SW = 4",
"const integer TERRAIN_PBR_OFFSET_1 = 16",
"const integer TERRAIN_PBR_OFFSET_2 = 17",
"const integer TERRAIN_PBR_OFFSET_3 = 18",
"const integer TERRAIN_PBR_OFFSET_4 = 19",
"const integer TERRAIN_PBR_ROTATION_1 = 12",
"const integer TERRAIN_PBR_ROTATION_2 = 13",
"const integer TERRAIN_PBR_ROTATION_3 = 14",
"const integer TERRAIN_PBR_ROTATION_4 = 15",
"const integer TERRAIN_PBR_SCALE_1 = 8",
"const integer TERRAIN_PBR_SCALE_2 = 9",
"const integer TERRAIN_PBR_SCALE_3 = 10",
"const integer TERRAIN_PBR_SCALE_4 = 11",
...
"const integer VEHICLE_FLAG_BLOCK_INTERFERENCE = 0x400",
...
"event at_rot_target( integer TargetNumber, rotation TargetRotation, rotation CurrentRotation )",
"event at_target( integer TargetNumber, vector TargetPosition, vector CurrentPosition )",
"event attach( key AvatarID )",
"event changed( integer Changed )",
"event collision( integer NumberOfCollisions )",
"event collision_end( integer NumberOfCollisions )",
"event collision_start( integer NumberOfCollisions )",
"event control( key AvatarID, integer Levels, integer Edges )",
"event dataserver( key RequestID, string Data )",
"event email( string Time, string Address, string Subject, string Body, integer NumberRemaining )",
"event experience_permissions( key agent_id )",
"event experience_permissions_denied( key agent_id, integer Reason )",
"event final_damage( integer count )",
"event game_control( key id, integer buttons, list axes )",
"event http_request( key HTTPRequestID, string HTTPMethod, string Body )",
"event http_response( key HTTPRequestID, integer Status, list Metadata, string Body )",
"event land_collision( vector Position )",
"event land_collision_end( vector Position )",
"event land_collision_start( vector Position )",
"event link_message( integer SendersLink, integer Value, string Text, key ID )",
"event linkset_data( integer action, string name, string value )",
"event listen( integer Channel, string Name, key ID, string Text )",
"event money( key Payer, integer Amount )",
"event moving_end(  )",
"event moving_start(  )",
"event no_sensor(  )",
"event not_at_rot_target(  )",
"event not_at_target(  )",
"event object_rez( key RezzedObjectsID )",
"event on_damage( integer count )",
"event on_death(  )",
"event on_rez( integer StartParameter )",
"event path_update( integer Type, list Reserved )",
"event remote_data( integer EventType, key ChannelID, key MessageID, string Sender, integer IData, string SData )",
"event run_time_permissions( integer PermissionFlags )",
"event sensor( integer NumberDetected )",
"event state_entry(  )",
"event state_exit(  )",
"event timer(  )",
"event touch( integer NumberOfTouches )",
"event touch_end( integer NumberOfTouches )",
"event touch_start( integer NumberOfTouches )",
"event transaction_result( key RequestID, integer Success, string Message )",
(char*)0 };
